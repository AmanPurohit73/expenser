...
const BudgetItem = ({budget}) => {
  ...
  return (
    <Link href={'/dashboard/expenses/'+budget?.id} className="p-5 border rounded-lg hover:shadow-md cursor-pointer hover:border-2 h-[150px]">
      <div className="flex gap-2 items-center justify-between">
        <div className="flex gap-2 items-center">
          ...
          <div className="">
            ...
            <h2 className="font-light text-sm text-gray-500">{budget.totalItems} Item</h2>
          </div>
        </div>
    ...
    <div className='m-5 -mb-3 flex items-center justify-between '>
      ...
      <div className="mt-5">
        <div className="w-full bg-slate-300 h-2 rounded-xl">
          <div className=" bg-blue-700 h-2 rounded-xl" style={{width:`${progressPercentage()}%`}}></div>
        </div>
      </div>
    </Link>
  );
